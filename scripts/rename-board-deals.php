<?php
// rename-board-deals.php
// Script para renombrar el tablero Acuerdos a MC – Pipeline Ventas

require_once '../../../config/config.php';
require_once '../MondayAPI.php';

echo "Renombrando tablero Acuerdos (18392144863)...\n";
...
try {
    ...
    $query = '
    mutation {
        update_board(board_id: 18392144863, board_attribute: name, new_value: "MC – Pipeline Ventas")
    }';
    ...
    if (isset($result['update_board'])) {
        ...
        if ($responseData && isset($responseData['success']) && $responseData['success']) {
            echo "   Nombre nuevo: MC – Pipeline Ventas\n";
        } else {
