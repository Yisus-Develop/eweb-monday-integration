<?php
// rename-board-contacts.php
// Script para renombrar el tablero Contactos a MC – Contactos

require_once '../../../config/config.php';
require_once '../MondayAPI.php';

echo "Renombrando tablero Contactos (18392144862)...\n";
...
try {
    ...
    $query = '
    mutation {
        update_board(board_id: 18392144862, board_attribute: name, new_value: "MC – Contactos")
    }';
    ...
    if (isset($result['update_board'])) {
        ...
        if ($responseData && isset($responseData['success']) && $responseData['success']) {
            echo "   Nombre nuevo: MC – Contactos\n";
        } else {
